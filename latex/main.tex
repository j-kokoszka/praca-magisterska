...
% Definiowanie terminów bezpośrednio w dokumencie zamiast \loadglsentries{glossary}
...
%     name=Kubernetes,
%     description={Platforma orkiestracji kontenerów}
% }
...
\input{tex/1-wstep/1-wstep}
\input{tex/2-podstawy-teoretyczne/2-podstawy-teoretyczne}
\input{tex/3-metodologia-badawcza/3-metodologia-badawcza}
\input{tex/4-implementacja-kubernetes/4-implementacja-kubernetes}
\input{tex/5-implementacja-mapek/5-implementacja-mapek}
\input{tex/6-analiza/6-analiza}
\input{tex/7-podsumowanie/7-podsumowanie}
