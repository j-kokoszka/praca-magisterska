...
\newacronym{controlplane}{CP}{Control Plane}
\newacronym{workernode}{WN}{Worker Node}
\newacronym{pod}{Pod}{Pod}
\newacronym{deployment}{Deployment}{Deployment}
\newacronym{service}{Service}{Service}
\newacronym{operator}{Operator}{Kubernetes Operator}